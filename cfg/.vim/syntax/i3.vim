...
" Config commands
syn keyword i3ConfigCommand focused unfocused urgent focused_inactive placeholder gaps smart_gaps smart_borders bind bindcode bindsym assign new_window popup_during_fullscreen font floating_modifier default_orientation workspace_layout for_window focus_follows_mouse bar position colors output tray_output tray_padding workspace_buttons workspace_auto_back_and_forth binding_mode_indicator debuglog floating_minimum_size floating_maximum_size force_focus_wrapping force_xinerama force_display_urgency_hint id hidden_state modifier new_float shmlog socket_path verbose mouse_warping strip_workspace_numbers focus_on_window_activation no_focus
...
""  Set form resource
syntax keyword  i3SetFrRsCmd set_from_resource nextgroup=i3SetFrRsVar skipwhite
syntax match    i3SetFrRsVar "\$\w\+" contained nextgroup=i3Resource skipwhite
syntax region   i3Resource start="\S" end="\s"he=e-1 contained nextgroup=i3SetVal skipwhite
highlight link  i3SetFrRsCmd    Define
highlight link  i3SetFrRsVar    Constant
highlight link  i3Resource      Keyword

syntax region   i3SetVal start=+\S+ end=+$+ contained skipwhite
highlight link  i3SetVal        Special
...
syntax keyword  i3Info Author author Maintainer maintainer vim file File description Description contained
syn match   i3Comment "^\s*#.*$" contains=i3Todo,i3Info
highlight link  i3Info          Special
